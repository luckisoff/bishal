    ...
    <div class="col-md-12">
        ...
        <div class="tabbable tabbable-custom tabbable-full-width">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_edit_account" data-toggle="tab">Create Menu</a></li>
            </ul>
            <div class="tab-content row">
                <!--=== Edit Account ===-->
                <div class="tab-pane active" id="tab_edit_account">
                    <form class="form-horizontal" action="{{route('dashboard.menu.store',$hotel)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-12">
                            <div class="widget">
                                            ...
                                            <div id="items" style="padding:10px">
                                                <div id="item" class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="number" name="items[0][price]" class="form-control" placeholder="Price of menu item in Rs.">
                                                    </div>
                                                    
                                                    <div class="form-group col-md-4">
                                                        <label for="name">Unit *</label>
                                                        <input type="text" name="items[0][unit]" class="form-control" placeholder="Unit of menu item eg. Plate">
            ...
            let template =
                        `
                            <div id="item" class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="name">Price *</label>
                                    <input type="number" name="items[${i}][price]" class="form-control" placeholder="Price of menu item in Rs.">
                                </div>
                                
                                <div class="form-group col-md-4">
                                    <label for="name">Unit *</label>
                                    <input type="text" name="items[${i}][unit]" class="form-control" placeholder="Unit of menu item eg. Plate">
                                </div>
