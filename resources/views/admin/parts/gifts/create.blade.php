        ...
        <div class="tabbable tabbable-custom tabbable-full-width">
            ...
            <div class="tab-content row">
                ...
                <div class="tab-pane active" id="tab_edit_account">
                    <form class="form-horizontal" action="{{route('dashboard.gift.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-12">
                            <div class="widget">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group col-md-8">
                                                    <input type="number" name="price" id="price" class="form-control" value="{{old('price')}}" placeholder="Current price of the item">
                                                    @error('price')
                                                        <div style="margin-top: 10px;">
                                                            <span class="invalid-feedback alert-danger" role="alert">
                                                                <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group col-md-8">
                                                    <input type="number" name="oldprice" id="oldprice" class="form-control" value="{{old('oldprice')}}" placeholder="Old price of the item">
                                                    @error('oldprice')
                                                        <div style="margin-top: 10px;">
                                                            <span class="invalid-feedback alert-danger" role="alert">
                                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group col-md-8">
                                                    <input type="number" name="height" id="height" class="form-control" value="{{old('height')}}" placeholder="Height of the pic">
                                                    @error('height')
                                                        <div style="margin-top: 10px;">
                                                            <span class="invalid-feedback alert-danger" role="alert">
                                                                <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group col-md-8">
                                                    <textarea name="description" class="form-control" placeholder="Description of the item">{{old('description')}}</textarea>
                                                    @error('description')
                                                        <div style="margin-top: 10px;">
                                                            <span class="invalid-feedback alert-danger" role="alert">
                                                                <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group col-md-8">
                                                    <input type="text" name="highlights" id="highlights" class="form-control" value="{{old('highlights')}}"  placeholder="Seperated by commas">
                                                    @error('Highlights')
                                                        <div style="margin-top: 10px;">
                                                            <span class="invalid-feedback alert-danger" role="alert">
                                                                <strong>{{ $message }}</strong>
